...
```{r}
#creating a subset of the eastern/midwest states around Colorado (CO, UT, NM, KS, WY) and looking at female population 22-24 years old
df.vars %>% dplyr::filter(concept == "SEX BY AGE") %>% 
